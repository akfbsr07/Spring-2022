...
/*
        ...
        4)What are the differences between "constructors" and "methods";
           ...
           ii)"constructors" do not have return type but "methods" must have a return type
           iii)The name of the "constructors" must match with the name of the Class, but "methods" can use any name
      */
