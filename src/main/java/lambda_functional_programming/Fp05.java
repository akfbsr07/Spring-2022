...
public class Fp05 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(checkIfAnyCoursesContainsGivenWord(coursesList, "Spanish"));
        System.out.println(getCourseNameWhoseAvgHighest(coursesList));
    ...
    public static boolean checkIfAnyCoursesContainsGivenWord(List<Courses> list, String word){
    ...
    public static String getCourseNameWhoseAvgHighest(List<Courses> list){
